...
Aplicación web desarrollada en **Java (Spring Boot)** para la gestión de citas médicas. Permite registrar pacientes, médicos y clínicas, gestionar horarios de citas medicas y generar reportes de facturación e historial médico.
